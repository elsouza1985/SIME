...
<div class="super_container">
	...
	<header class="header d-flex flex-row justify-content-end align-items-center">
		...
		<div class="logo_container mr-auto">
				<img src="images/logo_valor.png" alt  >
			<div class="logo">
				<a href="#"></a>
			</div>
		</div>
		...
		<!-- Hamburger -->
		<div class="hamburger_container" style="display: none">
	...
	<div class="fs_menu_container">
		...
		<div style="display:none!important" class="fs_social_container d-flex flex-row justify-content-end align-items-center">
			<ul class="fs_social">
